        ...
        {isEmpty ? (
          ...
          <div className="border shadow-md rounded-xl  border-black h-auto my-10 px-5 py-4">
            ...
            <div className="flex my-2">
              <h2 className="text-gray-600 font-semibold">{prop?.address}</h2>
            </div>
                ...
                <div className="mt-10 flex justify-between mx-auto w-full">
                  <Card className="w-full flex-row shadow-none ">
                    ...
                    <CardBody>
                      ...
                      <div className="w-full flex flex-col md:flex-row gap-x-5 md:items-center">
            ...
            <div className="w-full flex flex-col gap-y-7 items-start md:flex-row md:items-center md:justify-between mx-auto my-5">
              ...
              <div className="w-full ">
                <h1 className=" text-3xl font-semibold font-inter text-right ">
